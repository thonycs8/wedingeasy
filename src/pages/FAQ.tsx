            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                <AccordionTrigger className="text-left">
                  A aplicação weddingeasy é gratuita?
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground">
                  Sim! A weddingeasy oferece acesso gratuito às funcionalidades essenciais de planeamento
              ...
              <AccordionItem value="item-5">
                ...
                <AccordionContent className="text-muted-foreground">
                  Sim! A weddingeasy sincroniza automaticamente os seus dados na nuvem. Pode aceder ao
