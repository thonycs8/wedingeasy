...
-- Drop and recreate guests policies with correct permissions
...
DROP POLICY IF EXISTS "Users can insert wedding guests" ON public.guests;
...
-- Drop and recreate budget_categories policies
...
-- Drop and recreate budget_expenses policies
...
-- Drop and recreate timeline_tasks policies
